...
export default function BrowseMapLayout({ items }: { items: Listing[] }) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_520px]">
      {/* Mobile map (top) */}
      <div className="lg:hidden rounded-2xl overflow-hidden border border-neutral-200 h-[360px] bg-neutral-100">
        <ErrorBoundary
          fallback={
      ...
      <div className="hidden lg:block">
        <div className="sticky top-[132px] h-[calc(100vh-132px-24px)] rounded-2xl overflow-hidden border border-neutral-200 bg-neutral-100">
          <ErrorBoundary
            fallback={
              <div className="h-full w-full grid place-items-center text-sm text-neutral-600">
                Map failed to load. (Check browser console)
