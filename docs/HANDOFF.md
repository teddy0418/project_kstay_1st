...
We charge **12% guest service fee** and **0% host fee**, protecting Korean hosts and delivering best-value stays with transparent pricing.
...
- **Policies:** See `src/lib/policy.ts` (guest 12%, host 0%, 7-day free cancellation KST, 24h host decline).
