...
const DICT = {
  ...
  zh: {
    ...
    swipe_to_explore: "滑動或使用箭頭瀏覽",
    tap_to_explore: "點擊查看",
    popular: "熱門",
    search_cities_placeholder: "搜尋城市（例如：Seoul、Jeju）",
    selected: "已選擇",
    clear: "清除",
    done: "完成",
    today_tomorrow: "今天 → 明天（1 晚）",
    login_title: "登入或註冊",
    welcome_kstay: "歡迎來到 KSTAY",
    continue_google: "使用 Google 繼續",
    continue_email: "使用信箱繼續",
    email_placeholder: "信箱地址",
    continue: "繼續",
    night: "晚",
    nights: "晚",
    guest: "位",
    ...
    ages_0_12: "0–12 歲",
    total: "總計",
    board_headline: "韓國美食與攻略",
    board_subtitle: "發現餐廳、當地小貼士與旅行技巧。",
    back: "返回",
    read_more: "查看更多",
    ...
    empty_recently_viewed: "暫無最近瀏覽的住宿。",
    empty_trips: "暫無訂單。預訂後會顯示在這裡。",
    sign_in_to_manage: "請登入以管理個人資料。",
    logged_in_with: "登入方式",
    provider_google: "Google",
    provider_kakao: "Kakao",
    provider_line: "LINE",
