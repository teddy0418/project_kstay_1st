  ...
  if (!bookingId) {
    return (
      <div className="rounded-2xl border border-neutral-200 bg-white shadow-sm p-6">
        ...
        <Link href="/host/messages" className="mt-4 inline-block text-sm font-semibold underline">
          ← {t("messages_inbox")}
        </Link>
      </div>
    );
  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
      <div className="border-b border-neutral-100 p-4">
        ...
        <h2 className="mt-2 text-lg font-semibold">{t("messages_with_host")}</h2>
      </div>
