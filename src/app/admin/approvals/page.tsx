  ...
  return (
    <div className="grid gap-6">
      <div className="rounded-2xl border border-neutral-200 bg-white p-6">
        <div className="text-lg font-bold">Host Listing Approvals</div>
        <p className="mt-1 text-sm text-neutral-600">Pending listings submitted by hosts.</p>
      </div>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-xs text-neutral-500">
                    host: {item.host.name} ({item.host.id}) / ₩{item.basePriceKrw.toLocaleString()}
                  </div>
                </div>
