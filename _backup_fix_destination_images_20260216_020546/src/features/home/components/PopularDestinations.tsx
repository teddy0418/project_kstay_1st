        ...
        <div className="relative mt-4">
          {canLeft && (
            <button
              ...
              className="inline-flex absolute left-2 md:-left-3 top-1/2 -translate-y-1/2 z-10 h-10 w-10 md:h-11 md:w-11 items-center justify-center rounded-full bg-white/95 shadow-md hover:shadow-lg transition"
          ...
          {canRight && (
            <button
              type="button"
              onClick={() => scrollByDir(1)}
              className="inline-flex absolute right-2 md:-right-3 top-1/2 -translate-y-1/2 z-10 h-10 w-10 md:h-11 md:w-11 items-center justify-center rounded-full bg-white/95 shadow-md hover:shadow-lg transition"
